...
- **Google Antigravity** — Googleが提供する、AIエージェントが主体となって開発を進める開発環境（IDE）。作りたい内容を伝えると、AIが計画・実装・動作確認まで進めます。
- **GitHub Copilot** — VSCodeに組み込んで使えるAIコーディング補助。書いている途中のコードを提案してくれます。
